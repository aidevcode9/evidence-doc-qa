...
LATENCY_TARGET_MS = int(_getenv("DOCQA_LATENCY_TARGET_MS", "8000"))
REQUEST_DEADLINE_SECONDS = int(_getenv("DOCQA_REQUEST_DEADLINE_SECONDS", "30"))
...
AUTO_VERIFY_ENABLED = _is_truthy(_getenv("DOCQA_AUTO_VERIFY_ENABLED", "1"))
AUTO_VERIFY_RERANKER_MIN = float(
    _getenv("DOCQA_AUTO_VERIFY_RERANKER_MIN", _getenv("AUTO_VERIFY_RERANKER_MIN", "2.5"))
)
AUTO_VERIFY_OVERLAP_MIN = float(
    _getenv("DOCQA_AUTO_VERIFY_OVERLAP_MIN", _getenv("AUTO_VERIFY_OVERLAP_MIN", "0.3"))
)
